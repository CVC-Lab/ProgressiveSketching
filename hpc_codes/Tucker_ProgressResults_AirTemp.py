...
for i in tqdm(range(10)):
    ...
    np.save(f'outputs/AirTemp_err_logPS_{i}.npy',np.array(err_logPS))
    np.save(f'outputs/AirTemp_err_logRS_{i}.npy',np.array(err_logRS))
    np.save(f'outputs/AirTemp_nf_PS_{i}.npy',np.array(nf_PS))
    np.save(f'outputs/AirTemp_nf_RS_{i}.npy',np.array(nf_RS))
