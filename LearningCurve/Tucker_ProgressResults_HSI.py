...
hdr = sp.envi.open("../data/Hyperspectral_Project/indian_pines.hdr")
...
for i in tqdm(range(100)):
    ...
    np.save(f'outputs_AISTATS/HSI_err_log_PSCT_{i}.npy',np.array(err_logPS))
    np.save(f'outputs_AISTATS/HSI_err_log_RSCT_{i}.npy',np.array(err_logRS))
    np.save(f'outputs_AISTATS/HSI_memory_log_PSCT_{i}.npy',np.array(memory_logPS))
    np.save(f'outputs_AISTATS/HSI_memory_log_RSCT_{i}.npy',np.array(memory_logRS))
    np.save(f'outputs_AISTATS/HSI_nf_PSCT_{i}.npy',np.array(nf_PS))
    np.save(f'outputs_AISTATS/HSI_nf_RSCT_{i}.npy',np.array(nf_RS))
