...
for i in tqdm(range(100)):
    logPS_0, logPS_1, logPS_2 = pgskt_log(A,r,10,30,600)
    logRS_0, logRS_1, logRS_2 = rdskt_log(A,r,10,30,600)
    ...
    np.save(f'outputs_AISTATS/AirTemp_err_log_PSCT_{i}.npy',np.array(err_logPS))
    np.save(f'outputs_AISTATS/AirTemp_err_log_RSCT_{i}.npy',np.array(err_logRS))
    np.save(f'outputs_AISTATS/AirTemp_memory_log_PSCT_{i}.npy',np.array(memory_logPS))
    np.save(f'outputs_AISTATS/AirTemp_memory_log_RSCT_{i}.npy',np.array(memory_logRS))
    np.save(f'outputs_AISTATS/AirTemp_nf_PSCT_{i}.npy',np.array(nf_PS))
    np.save(f'outputs_AISTATS/AirTemp_nf_RSCT_{i}.npy',np.array(nf_RS))
